...
def feature_engineering_neighbors_EXT_SOURCE(dataframe):
    ...
    with open('/content/drive/My Drive/sauvegarde/pre-processing/TARGET_MEAN_500_Neighbors_training_data.pkl', 'wb') as f:
    ...
    with open('/content/drive/My Drive/sauvegarde/pre-processing/KNN_model_TARGET_500_neighbors.pkl', 'wb') as f:
         pickle.dump(knn, f)
...
def features_selection_boruta(dataframe, titre):
    ...
    fic_sav_fs_boruta = \
        '/content/drive/My Drive/sauvegarde/features-selection/' + titre + '.pickle'
