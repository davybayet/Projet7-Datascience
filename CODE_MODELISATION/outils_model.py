...
# ====================================================================
# Outils ML -  projets Openclassrooms
# ====================================================================
...
def process_classification(model, X_train, X_valid, y_train, y_valid,
    ...
    with open('/content/drive/My Drive/sauvegarde/modelisation/modele_' + titre + '.pickle', 'wb') as f:
    ...
    with open('/content/drive/My Drive/sauvegarde/modelisation/df_resultat_scores.pickle', 'wb') as df:
...
def process_classification_seuil(model, seuil, X_train, X_valid, y_train,
    ...
    # Sauvegarde du tableau de résultat
    with open('/content/drive/My Drive/sauvegarde/modelisation/df_res_seuil.pickle', 'wb') as df:
...
def sauvegarder_taux(titre_modele, FN, FP, TP, TN, df_taux):
    ...
    # Sauvegarde du tableau de résultat
    with open('/content/drive/My Drive/sauvegarde/modelisation/df_taux.pickle', 'wb') as df:
